...
import com.ty.nanfangscanner.adapter.CommitFailAdapter;
...
public class CommitFailActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<RegisterCheckInfo> failList= getIntent().getParcelableArrayListExtra("failList");
        if (failList!=null){
            CommitFailAdapter adapter=new CommitFailAdapter(failList);
