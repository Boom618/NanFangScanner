...
import com.ty.nanfangscanner.adapter.RegisterRecordAdapter;
...
public class RegisterRecordActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    List<RegisterRecordInfo> list = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new RegisterRecordAdapter(list);
    ...
    private void getActivationRecord(RequestBody requestBody) {
        HttpMethods.getInstance().getRegisterRecord(new ProgressSubscriber<List<RegisterRecordInfo>>(this, true) {
            @Override
            public void onNext(List<RegisterRecordInfo> registerRecordInfos) {
                super.onNext(registerRecordInfos);
                if (registerRecordInfos != null) {
                    tvNull.setVisibility(View.GONE);
                    rvRecord.setVisibility(View.VISIBLE);
                    list.clear();
                    list.addAll(registerRecordInfos);
